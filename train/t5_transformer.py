...
def main(args):
    ...
    vis = Transformer2DModel.from_pretrained("PixArt-alpha/PixArt-XL-2-512x512", subfolder="transformer")
    ...
    adapter = TextAdapter(1024, 2560, 4096)
    ...
    params_to_optimize = ([
        {"params": itertools.chain(*vis_lora_params), "lr": 2e-5},
        {"params": itertools.chain(*text_encoder_lora_params), "lr": 5e-6},
        {"params": adapter.parameters(), "lr": 2e-5},
    ])
